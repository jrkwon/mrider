...
Last Monday was 개천절 — no class. **Lab 4 is due today.**

This session is the densest of the foundation block:
URDF → TF2 → Gazebo → `ros2_control`, in one sitting.

Which is exactly why it was kept **live** rather than
sent home over the break.

- **Lab 5** — URDF, TF, and a deliberately broken map — due **10/19**
- **Track preference form** — due **Friday 10/16**
- **Teams announced next week**
...
Lab 5 has you introduce a **5 cm** error and watch it fail.
...
Due **Friday 10/16**. Read [Teams & Tracks](https://jrkwon.github.io/mrider/course/teams/) first.
...
Teams are **assigned**, announced 10/19. "No experience" is a fine answer.
