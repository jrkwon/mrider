...
| 5 | Sabertooth signal ground loop / PWM noise | erratic or corrupted motor command | 3 | common-ground star at the Sabertooth, RC receiver and signal MUX; R/C signal-loss timeout stops motors on invalid pulses | pulse validity + timeout (2) |
